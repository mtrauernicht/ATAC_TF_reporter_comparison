...
bam_dir <- "/DATA/usr/m.trauernicht/projects/ATAC_TF_reporter_comparison/ATAC_seq_analyses/bam/7784_human_comb"
...
table_out <- here("ATAC_seq_analyses/rds", "bamfile_atacseq_metadata_human.rds")

files <- read.table("ATAC_seq_analyses/ATAC_seq_samples_human_comb.tsv", 
