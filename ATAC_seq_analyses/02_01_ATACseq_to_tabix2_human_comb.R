...
files <- readRDS(here("ATAC_seq_analyses/rds", "bamfile_atacseq_metadata_human.rds"))
dir <- "/DATA/usr/m.trauernicht/projects/ATAC_TF_reporter_comparison/ATAC_seq_analyses/"
dir_in  <- glue("{dir}bam/7784_human_comb")
dir_out <- glue("{dir}tabix/7784_human_comb")
...
saveRDS(files, here("ATAC_seq_analyses/rds", "bamfile_atacseq_metadata2_human_comb.rds"))
