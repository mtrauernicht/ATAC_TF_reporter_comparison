...
metadata_df <- read_csv2("/DATA/usr/m.trauernicht/projects/ATAC_TF_reporter_comparison/TF_reporter_analyses/mt20240719_metadata_all.csv")
...
bc_df_cDNA_filt_short <- bc_df_cDNA_filt %>%
  dplyr::select(-background_activity, -reporter_id2, -mutated_activity, -pDNA, -starcode_counts, -nchar, -transfection, -rpm,
